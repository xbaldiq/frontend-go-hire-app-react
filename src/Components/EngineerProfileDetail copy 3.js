...
class EngineerProfileDetail extends Component {
  ...
  componentDidMount = async () => {
    ...
    this.setState({nameDefault: this.props.engineerProfile.engineerProfile.name })
  };
  ...
  handleEditClick = (e) => {
    ...
    this.setState({nameDefault: e.target.value})
            ...
            <Paper>
              <List component='nav' aria-label='main mailbox folders'>
                ...
                <ListItem>
                  ...
                  <TextField value={this.state.nameDefault} name='name' onChange={this.handleEditClick}/>
                  {/* <ListItemText primary={engineerProfile.name} /> */}
                  <ListItemIcon>
                  {this.state.onChangeTrigger ? this.showApplyButton() : ''}
                    {/* <Button
